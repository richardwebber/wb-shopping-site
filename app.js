...
app.get('/cart', (req, res) => {
  // If there is nothing in our session cart, we will create a cart.
  // That cart will be an empty opbject.
  if (!req.session.cart) {
    req.session.cart = {};
  }
  // here we are creating a variable for our cart so that we can better access our session information.
